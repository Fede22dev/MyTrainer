...
class SaveTrainer() {
    ...
    fun setEmailTrainer(name: String): Boolean {
        ...
        return if(nameOk){ hashMapTrainer["Email"] = name
            true
        }else{
            false
        }
    ...
    fun setPassTrainer(pass: String): Boolean {
        ...
        return if(nameOk){ hashMapTrainer["Password"] = pass
            true
        }else{
            false
        }
    ...
    fun setNameTrainer(name: String): Boolean{
        val nameOk=checkField.checkName(name)
        return if(nameOk){ hashMapTrainer["Name"] = name
            true
        }else{
            false
        }
    ...
    fun setSurnameTrainer(surname: String): Boolean {
        ...
        return if(nameOk){ hashMapTrainer["Surname"] = surname
            true
        }else{
            false
        }
    ...
    fun setBirthTrainer(birth: String): Boolean {
        ...
        return if(nameOk){ hashMapTrainer["DateOfBirth"] = birth
            true
        }else{
            false
        }
